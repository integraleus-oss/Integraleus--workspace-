Implement the frozen universal read-only integration slice in the isolated Alpha BPR R3 worktree.
...
- project worktree: `/home/stanislav/agent-runs/orchestrator-worktrees/alpha-bpr-universal-integration-r3`
- run root: `/home/stanislav/agent-runs/orchestrator-worktrees/alpha-bpr-universal-integration-r3-run`
- .NET artifact root: `/tmp/alpha-bpr-universal-integration-r3-artifacts`
- only authorized .NET entrypoint: `/home/stanislav/.openclaw/workspace/agents/main/state/tasks/2026-08-21-alpha-bpr-universal-integration-r3/DOTNET_HARNESS.sh`
...
The production launcher binds the artifact root as the packet's sole additional writable directory. Do not write anywhere else outside the project worktree.
