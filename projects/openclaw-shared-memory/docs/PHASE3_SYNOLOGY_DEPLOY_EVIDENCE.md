...
- Installing Docker/Container Manager or another container runtime is a separate Synology package/root-level change and was not included in this approval.
