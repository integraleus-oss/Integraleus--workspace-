...
|--------|-------|------------|
| Q1 2026 (янв–март) | `releases_2026_Q1.md` | Полный анализ: Alpha.Server 6.1.12–6.4.30, DevStudio 4.2.0, Domain 1.5.3, Historian 4.0.4, Security 1.7.27–1.7.28, HMI 2.0.33 + все компоненты. Топ-9 ключевых изменений для руководства. Детальный лог по модулям. |
